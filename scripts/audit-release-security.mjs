...
const requiredPrivilegeBoundaryText = [
  ...
  ['one broker session multiplexes privileged programs', privilegeBoundarySources.broker, /HashMap<ProgramId, mpsc::UnboundedSender/],
  ...
  ['broker disconnect terminates the managed tree', privilegeBoundarySources.executable, /terminate_managed\(&mut child\)/],
